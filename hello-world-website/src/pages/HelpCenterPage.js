      ...
      <section className="relative w-full bg-gray-50 py-16 md:py-24">
        <div className="max-w-5xl mx-auto px-6 md:px-12 text-center">
          <div className="bg-white rounded-2xl p-8 md:p-12 shadow-lg">
            ...
            <h2 className="text-2xl md:text-4xl font-thin text-black mb-6">Support Resources Coming Soon</h2>
            <p className="text-lg font-thin text-gray-600 mb-8 max-w-3xl mx-auto">
              We're building a comprehensive help center with step-by-step tutorials, frequently asked questions, 
              and troubleshooting guides to help you get the most out of our AI products.
            </p>
