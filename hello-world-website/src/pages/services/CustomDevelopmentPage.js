  ...
  return (
    <div className="relative w-full bg-white overflow-hidden">
      ...
      <section className="relative w-full bg-white py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-thin text-black mb-6">Development Success</h2>
            <p className="text-lg font-thin text-gray-600 max-w-3xl mx-auto">
              How we developed a custom computer vision system that revolutionized quality control 
          ...
          <div className="bg-gray-50 rounded-2xl p-8 md:p-12">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              <div>
                ...
                <p className="text-base font-thin text-gray-600 mb-6">
                  An automotive manufacturer needed to detect microscopic defects in engine components 
                  with 99.9% accuracy while maintaining production line speeds of 500 parts per minute. 
                  Existing solutions couldn't meet these dual requirements.
                </p>
                <div className="space-y-3">
                  <div className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-red-500 rounded-full"></div>
                    <span className="text-sm font-thin text-gray-600">Manual inspection too slow for production demands</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-red-500 rounded-full"></div>
                    <span className="text-sm font-thin text-gray-600">Commercial vision systems lacked required precision</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-red-500 rounded-full"></div>
                    <span className="text-sm font-thin text-gray-600">Complex defect patterns required advanced detection</span>
                  </div>
                </div>
              </div>
              <div>
                ...
                <p className="text-base font-thin text-gray-600 mb-6">
                  We developed a custom deep learning model using advanced convolutional neural 
                  networks, optimized specifically for their defect patterns and production 
                  environment constraints.
                </p>
                <div className="space-y-3">
                  <div className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                    <span className="text-sm font-thin text-gray-600">Custom CNN architecture for microscopic defect detection</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                    <span className="text-sm font-thin text-gray-600">Real-time processing optimized for production speeds</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                    <span className="text-sm font-thin text-gray-600">Adaptive learning system for new defect patterns</span>
                  </div>
                </div>
              </div>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12 pt-12 border-t border-gray-200">
              <div className="text-center">
                <div className="text-3xl font-thin text-black mb-2">99.95%</div>
                <div className="text-base font-thin text-gray-600">Detection Accuracy</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-thin text-black mb-2">600/min</div>
                <div className="text-base font-thin text-gray-600">Processing Speed</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-thin text-black mb-2">$8M</div>
