  ...
  return (
    <div className="relative w-full bg-white overflow-hidden">
      ...
      <section className="relative w-full bg-white py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-thin text-black mb-6">Success Story</h2>
            <p className="text-lg font-thin text-gray-600 max-w-3xl mx-auto">
              How we helped a Fortune 500 company transform their operations with strategic AI implementation.
            </p>
          </div>
          ...
          <div className="bg-gray-50 rounded-2xl p-8 md:p-12">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              <div>
                ...
                <p className="text-base font-thin text-gray-600 mb-6">
                  A global manufacturing company struggled with inefficient supply chain operations, 
                  quality control issues, and limited predictive capabilities. Multiple departments 
                  had attempted AI pilots independently with mixed results.
                </p>
                <div className="space-y-3">
                  <div className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-red-500 rounded-full"></div>
                    <span className="text-sm font-thin text-gray-600">Disconnected AI initiatives across departments</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-red-500 rounded-full"></div>
                    <span className="text-sm font-thin text-gray-600">Limited data integration and quality issues</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-red-500 rounded-full"></div>
                    <span className="text-sm font-thin text-gray-600">Unclear ROI from existing AI investments</span>
                  </div>
                </div>
              </div>
              <div>
                ...
                <p className="text-base font-thin text-gray-600 mb-6">
                  We developed a comprehensive AI strategy that unified their efforts around 
                  three core objectives: supply chain optimization, predictive maintenance, 
                  and quality assurance automation.
                </p>
                <div className="space-y-3">
                  <div className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                    <span className="text-sm font-thin text-gray-600">Integrated AI platform with centralized data</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                    <span className="text-sm font-thin text-gray-600">Phased implementation reducing operational risk</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                    <span className="text-sm font-thin text-gray-600">Clear success metrics and governance framework</span>
                  </div>
                </div>
              </div>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12 pt-12 border-t border-gray-200">
              <div className="text-center">
                <div className="text-3xl font-thin text-black mb-2">$15M</div>
                <div className="text-base font-thin text-gray-600">Annual Cost Savings</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-thin text-black mb-2">40%</div>
                <div className="text-base font-thin text-gray-600">Reduction in Downtime</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-thin text-black mb-2">95%</div>
                <div className="text-base font-thin text-gray-600">Quality Improvement</div>
              </div>
            </div>
          </div>
        </div>
