    ...
    <div className="relative w-full bg-white overflow-hidden">
      ...
      <section className="relative w-full bg-white pt-32 pb-16 md:pt-40 md:pb-24">
        <div className="max-w-7xl mx-auto px-6 md:px-12 text-center">
          <h1 className="text-4xl md:text-6xl font-thin text-[#998664] mb-6">AI Strategy</h1>
      ...
      <section className="relative w-full bg-gradient-to-r from-[#998664] to-[#aa9678] py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl md:text-5xl font-thin text-white mb-8">Strategic AI Transformation</h2>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm">
              <h3 className="text-2xl font-thin text-[#998664] mb-6">Strategy Components</h3>
          ...
          <div className="space-y-12">
            <div className="flex flex-col md:flex-row items-start gap-8">
              ...
              <div className="w-full md:w-3/4">
                <h3 className="text-2xl font-thin text-[#998664] mb-4">Business & Technology Assessment</h3>
            ...
            <div className="flex flex-col md:flex-row items-start gap-8">
              ...
              <div className="w-full md:w-3/4">
                <h3 className="text-2xl font-thin text-[#998664] mb-4">AI Opportunity Mapping</h3>
                <p className="text-base font-thin text-gray-600 mb-4">
            ...
            <div className="flex flex-col md:flex-row items-start gap-8">
              ...
              <div className="w-full md:w-3/4">
                <h3 className="text-2xl font-thin text-[#998664] mb-4">Implementation Roadmap</h3>
                <p className="text-base font-thin text-gray-600 mb-4">
      ...
      <section className="relative w-full bg-gradient-to-r from-[#998664] to-[#aa9678] py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-thin text-white mb-6">Expected Benefits</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-2xl p-8 text-center shadow-sm">
              <div className="text-4xl font-thin text-[#998664] mb-4">Faster</div>
              <h3 className="text-xl font-thin text-[#998664] mb-4">Implementation</h3>
            ...
            <div className="bg-white rounded-2xl p-8 text-center shadow-sm">
              <div className="text-4xl font-thin text-[#998664] mb-4">Higher</div>
              <h3 className="text-xl font-thin text-[#998664] mb-4">ROI Potential</h3>
              <p className="text-base font-thin text-gray-600">
            ...
            <div className="bg-white rounded-2xl p-8 text-center shadow-sm">
              <div className="text-4xl font-thin text-[#998664] mb-4">Reduced</div>
              <h3 className="text-xl font-thin text-[#998664] mb-4">Risk</h3>
              <p className="text-base font-thin text-gray-600">
