    ...
    <div className="relative w-full bg-white overflow-hidden">
      ...
      <section className="relative w-full bg-white pt-32 pb-16 md:pt-40 md:pb-24">
        <div className="max-w-7xl mx-auto px-6 md:px-12 text-center">
          <h1 className="text-4xl md:text-6xl font-thin text-[#998664] mb-6">Custom Development</h1>
      ...
      <section className="relative w-full bg-gradient-to-r from-[#998664] to-[#aa9678] py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl md:text-5xl font-thin text-white mb-8">Bespoke AI Solutions</h2>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm">
              <h3 className="text-2xl font-thin text-[#998664] mb-6">Development Capabilities</h3>
      ...
      <section className="relative w-full bg-white py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-thin text-[#998664] mb-6">Development Process</h2>
          ...
          <div className="space-y-12">
            <div className="flex flex-col md:flex-row items-start gap-8">
              ...
              <div className="w-full md:w-3/4">
                <h3 className="text-2xl font-thin text-[#998664] mb-4">Requirements & Data Assessment</h3>
            ...
            <div className="flex flex-col md:flex-row items-start gap-8">
              ...
              <div className="w-full md:w-3/4">
                <h3 className="text-2xl font-thin text-[#998664] mb-4">Architecture & Model Design</h3>
                <p className="text-base font-thin text-gray-600 mb-4">
            ...
            <div className="flex flex-col md:flex-row items-start gap-8">
              ...
              <div className="w-full md:w-3/4">
                <h3 className="text-2xl font-thin text-[#998664] mb-4">Implementation & Testing</h3>
                <p className="text-base font-thin text-gray-600 mb-4">
