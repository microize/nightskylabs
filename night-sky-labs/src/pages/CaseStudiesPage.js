      ...
      <section className="relative w-full bg-white pt-32 pb-16 md:pt-40 md:pb-24">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="text-center mb-16">
            <h1 className="text-4xl md:text-6xl font-thin text-[#998664] mb-6">Case Studies</h1>
            ...
            <p className="text-lg md:text-xl font-thin text-gray-600 max-w-4xl mx-auto">
              Real-world AI transformations showcasing measurable business impact and technical innovation.
            </p>
          </div>
        </div>
      </section>
